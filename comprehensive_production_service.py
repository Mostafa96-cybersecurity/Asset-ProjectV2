...
if __name__ == '__main__':
    ...
    print("🔍 API Asset Details: http://127.0.0.1:5000/api/assets/1")
    print("🔄 API Collect Asset: http://127.0.0.1:5000/api/collect/hostname")
    print("🚀 API Enhanced Collection: http://127.0.0.1:5000/api/collect-enhanced/hostname")
    print("🤖 API Automation Status: http://127.0.0.1:5000/api/automation-status")
    print("=" * 70)
